      ...
      <Container>
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link href="#" className="text-sm font-inter text-[#CDCDCD] hover:text-[#AD46FF] transition-colors">About</Link>
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link href="#" className="text-sm font-inter text-[#CDCDCD] hover:text-[#AD46FF] transition-colors">Privacy Policy</Link>
